    ...
    default:
      ...
      echo "<div class='panel panel-primary'>
        <div class='panel-heading'>
          <h3 class='panel-title'><i class='fa fa-key'></i> Ganti Password</h3>
          </div>
          <div class='panel-body'>
            <form class='form-horizontal' method=post action='act_buatcuti.php'>
              ...
              <div class='form-group'>
                <label class='col-sm-2 control-label no-padding-right' for='form-field-1'> Ganti Password </label>
                <div class='col-sm-5'>
                  <input type='password' name='' class='form-control' required/>
                </div>
              </div>
              ...
              <div class='form-group'>
                ...
                <div class='col-sm-5'>
                  ...
                  <button type=button value='simpan' class='btn btn-warning btn-lg'>Kembali</button>
                </div>
              </div>
            </form>
          </div>
